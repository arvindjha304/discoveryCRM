...
class gridPdfWrapper {
	...
	public function gridPdfWrapper($offsetTop, $offsetRight, $offsetBottom, $offsetLeft, $orientation='L', $fontSize = 8, $dpi = 72, $lang) {
	...
	public function pdfOut($reportType='',$filename='') {
		$this->cb->setFooterMargin($this->minOffsetBottom);
		// send PDF-file in browser
		if($reportType == 'reportBuilder')
			$this->cb->Output('C:\Users\Arvind\Desktop\reportExportFiles\grid_'.date("Y_m_d__H_i_s").'.pdf', 'F');
		else
